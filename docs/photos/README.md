...
- `breadboard-dev-progress-1.jpg` / `breadboard-dev-progress-2.jpg`：更早期的面包板搭建过程实拍（ESP32、STM32 Blue Pill、BH1750、AHT20、SSD1306、EC11、HC-SR501、逻辑分析仪接线），非最终装配状态；最终整机实物图待补。
